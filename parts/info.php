...
<fieldset>
	...
	<div class="itemGroup">
	    ...
	    <div class="itemValue"><input class="required" id="FirstName" name="FirstName" type="text" value="" placeholder="Legal First Name (Required)"></div>
	</div>
	<div class="itemGroup">
	    <div class="itemLabel">Middle Name</div>
	    <div class="itemValue"><input id="MiddleName" name="MiddleName" type="text" value="" placeholder="Middle Name"></div>
	</div>
	<div class="itemGroup">
	    <div class="itemLabel">Last Name *</div>
	    <div class="itemValue"><input class="required" id="LastName" name="LastName" type="text" value="" placeholder="Last Name"></div>
	</div>
...
<fieldset>
    ...
    <div class="group two-columns">
        ...
        <!-- Country Select -->
        <div class="itemGroup">
            <div class="itemLabel">Country</div>
            <div class="itemValue">
